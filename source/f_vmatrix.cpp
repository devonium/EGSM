...
inline void MatrixBuildRotationAboutAxis(const Vector& vAxisOfRot, float angleDegrees, matrix3x4_t& dst) { AssertFatalMsg(1, "This should be never called?"); }
//void MatrixBuildRotationAboutAxis(const Vector& vAxisOfRot, float angleDegrees, matrix3x4_t& dst);
inline void ClearBounds(Vector& mins, Vector& maxs) { AssertFatalMsg(1, "This should be never called?"); }
//void ClearBounds(Vector& mins, Vector& maxs);
inline void AddPointToBounds(const Vector& v, Vector& mins, Vector& maxs) { AssertFatalMsg(1, "This should be never called?"); }
...
extern const Vector vec3_origin(0,0,0);
...
public:
	...
	{
		AssertFatalMsg(1, "This should be never called?");
...
void FrustumPlanesFromMatrix( const VMatrix &clipToWorld, f_Frustum_t&frustum )
{
	Vector normal;
	float dist;
