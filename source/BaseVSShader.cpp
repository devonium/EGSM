...
#include <vs/unlitgeneric_vs11.inc>
#include <vs/VertexLitGeneric_EnvmappedBumpmap_NoLighting_ps14.inc>
#include <vs/VertexLitGeneric_EnvmappedBumpmap_NoLighting.inc>
#include <vs/vertexlitgeneric_flashlight_vs11.inc>
#include <vs/LightmappedGeneric_BaseTexture.inc>
#include <vs/LightmappedGeneric_BumpmappedLightmap_Base_ps14.inc>
#include <vs/LightmappedGeneric_BumpmappedLightmap_Blend_ps14.inc>
#include <vs/lightmappedgeneric_bumpmappedenvmap_ps14.inc>
#include <vs/lightmappedgeneric_bumpmappedenvmap.inc>
#include <vs/lightmappedgeneric_basetextureblend.inc>
#include <vs/lightmappedgeneric_bumpmappedlightmap.inc>
...
bool s_bGammaToLinearInitialized = false;

float GammaToLinear(float gamma)
{
	if (!s_bGammaToLinearInitialized)
	{
		for (int i = 0; i < 256; i++)
		{
		...
		s_bGammaToLinearInitialized = true;
	}
	if (gamma < 0.0f)
	{
		return 0.0f;
