	...
	int MenuInit(GarrysMod::Lua::ILuaBase* LUA)
	{
...

		{
			static const char sign[] =
				...
				HOOK_SIGN_CHROMIUM_x64("48 89 54 24 10 48 89 4C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 83 EC 40 48 8B 41 08 45 32 F6 49 63 F0 4D 8B E1 4C 8B EA 4C 8B F9 0F B6 A8 58 02 00 00 48 8B B8 50 02 00 00 40 88 AC 24 90 00 00 00 83 FE 1F 77 20 4C 8B 84 F0 60 02 00 00 4D 85 C0 74 13 0F B6")
...

		{
			static const char sign[] =
				...
				HOOK_SIGN_CHROMIUM_x64("40 53 48 83 EC 30 48 8B D9 48 8B ? ? ? ? ? 83 B9 0C 10 00 00 00 74 49 C7 44 24 28 04 00 00 00 4C 8D ? ? ? ? ? 45 33 C0 C6 44 24")
